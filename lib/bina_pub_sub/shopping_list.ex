defmodule BinaPubSub.ShoppingList do
  use GenServer

  def start_link() do
    IO.puts("Starting SUBSCRIBER process.. => shopping list")
  ...
  def init(_) do
    IO.puts("SUBSCRIBING to STORE_UPDATES... ")
    Phoenix.PubSub.subscribe(:store, "store_updates")
    {:ok, %{}}
  end
